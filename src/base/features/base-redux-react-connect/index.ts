...
import { WithAppContext } from '@base/features/base-context';

export function baseConnect<S, D, O>(component: any, mapStateToProps: any, propsToDispatch: any) {
	const componentWithContext = WithAppContext<any>(component);
	const componentWithRouter = withRouter(componentWithContext);
	return (
		connect<S, D, O>(
